...
from app.api import nlq_analytics  # <-- new analytics API
from app.api import snowflake_api  # <-- new snowflake API
...
app.include_router(nlq_analytics.router)
app.include_router(snowflake_api.router, prefix="/api")
